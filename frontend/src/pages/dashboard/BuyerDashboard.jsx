...
const BuyerDashboard = () => {
    ...
    return (
        <div style={S.container}>
            ...
            <div style={S.grid}>
                <div className="ui-card ui-lift" style={S.card}>
                    <h2 style={S.cardTitle}>My Biddings</h2>
                    <p style={S.cardText}>Track current bids, see updates, and follow auction results.</p>
                    <button className="btn-primary" style={S.actionBtn} onClick={() => navigate('/dashboard/bids')}>
                        Open Biddings
                    </button>
                </div>
                ...
                <div className="ui-card ui-lift" style={S.card}>
                    ...
                    <button className="btn-primary" style={S.actionBtn} onClick={() => navigate('/dashboard/visits')}>
                        Open Visits
                    </button>
                </div>
                ...
                <div className="ui-card ui-lift" style={S.card}>
                    ...
                    <button className="btn-primary" style={S.actionBtn} onClick={() => navigate('/dashboard/properties')}>
                        Open Saved
                    </button>
                </div>
                ...
                <div className="ui-card ui-lift" style={S.card}>
                    ...
                    <button className="btn-primary" style={S.actionBtn} onClick={() => navigate('/services')}>
            ...
            <section style={S.section}>
                <div style={S.sectionHead}>
                    ...
                    <button className="btn-secondary" style={S.smallBtn} onClick={() => navigate('/services')}>View All</button>
                </div>
                ...
                {serviceBookings.length === 0 ? (
                    ...
                    <div style={S.list}>
                        {serviceBookings.slice(0, 3).map((booking) => (
                            <div key={booking.id} className="ui-card ui-lift" style={S.listCard}>
                                <div style={S.listTop}>
...
const S = {
    ...
    card: { background: '#fff', borderRadius: '20px', padding: '24px', boxShadow: 'none', border: '1px solid rgba(38, 50, 56, 0.08)' },
    cardTitle: { fontSize: '1.1rem', fontWeight: '800', margin: '0 0 8px', color: 'var(--color-dark)' },
    cardText: { fontSize: '0.92rem', color: 'var(--color-muted)', marginBottom: '16px', lineHeight: 1.45 },
    ...
    emptyBox: { background: '#fff', borderRadius: '12px', border: '1px solid rgba(38, 50, 56, 0.1)', padding: '16px', color: 'var(--color-muted)' },
    list: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '14px' },
    listCard: { background: '#fff', borderRadius: '12px', border: '1px solid rgba(38, 50, 56, 0.08)', padding: '14px' },
    listTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' },
    listText: { color: 'var(--color-muted)', fontSize: '0.9rem', marginBottom: '4px' },
    contactText: { color: 'var(--color-blue)', fontSize: '0.82rem', marginTop: '6px' },
    statusPill: { background: 'rgba(76, 175, 80, 0.16)', color: '#2e7d32', padding: '4px 8px', borderRadius: '999px', fontSize: '0.75rem', fontWeight: '700' }
};
