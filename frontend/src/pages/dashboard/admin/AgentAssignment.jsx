...
const styles = {
    ...
    card: { backgroundColor: '#fff', borderRadius: '12px', border: '1px solid var(--color-border)', padding: '24px', boxShadow: 'var(--shadow-soft)' },
    ...
    agentItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px', backgroundColor: 'var(--color-bg)', borderRadius: '8px' },
    ...
    thRow: { borderBottom: '2px solid var(--color-border)' },
    ...
    select: { padding: '8px 12px', borderRadius: '6px', border: '1px solid var(--color-border)', fontSize: '0.85rem', color: '#333', cursor: 'pointer', outline: 'none' },
