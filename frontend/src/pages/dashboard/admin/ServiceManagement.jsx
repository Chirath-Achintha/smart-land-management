...
const ServiceManagement = () => {
    ...
    useEffect(() => {
        const timers = sortedBookings.map((booking, idx) =>
            setTimeout(() => {
                                ...
                                {sortedBookings.map((booking) => {
                                    ...
                                    return (
                                        <tr
                                            ...
                                            style={{
                                                ...styles.tr,
                                                opacity: animatedRows[booking.id] ? 1 : 0,
                                                transform: animatedRows[booking.id] ? 'translateY(0)' : 'translateY(10px)',
...
const styles = {
    ...
    subtitle: { marginTop: '8px', color: 'var(--color-muted)', maxWidth: '760px' },
    card: { background: '#fff', borderRadius: '14px', border: '1px solid var(--color-accent)', padding: '20px', marginBottom: '20px', boxShadow: '0 14px 30px rgba(26,26,26,0.06)' },
    ...
    input: { border: '1px solid var(--color-accent)', borderRadius: '8px', padding: '10px 12px', fontSize: '0.9rem' },
    primaryBtn: { border: 'none', background: 'var(--color-primary)', color: '#fff', borderRadius: '8px', padding: '10px 14px', cursor: 'pointer', fontWeight: 700, width: '220px', transition: 'all 0.2s ease' },
    ...
    viewBtn: { border: '1px solid #86EFAC', background: '#ECFDF5', color: '#166534', borderRadius: '8px', padding: '6px 10px', cursor: 'pointer', fontSize: '0.8rem', fontWeight: 700 },
    ...
    refreshBtn: { border: '1px solid #86EFAC', background: '#ECFDF5', color: '#166534', borderRadius: '8px', padding: '8px 14px', cursor: 'pointer', fontWeight: 600 },
    ...
    tr: { borderBottom: '1px solid #F4EFE7' },
    ...
    select: { width: '100%', minWidth: '280px', border: '1px solid var(--color-accent)', borderRadius: '8px', padding: '8px 10px' },
    ...
    modal: { width: 'min(980px, 92vw)', maxHeight: '82vh', overflow: 'auto', background: '#fff', borderRadius: '14px', padding: '18px', border: '1px solid var(--color-accent)', animation: 'modalPopIn 0.24s ease' },
    ...
    closeBtn: { border: '1px solid #86EFAC', background: '#ECFDF5', color: '#166534', borderRadius: '8px', padding: '6px 10px', cursor: 'pointer', fontWeight: 700 },
