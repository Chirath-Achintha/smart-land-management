...
const styles = {
    ...
    searchInput: { width: '100%', padding: '12px 20px', borderRadius: '10px', border: '1px solid var(--color-border)', fontSize: '0.9rem', outline: 'none', boxSizing: 'border-box', backgroundColor: '#fff', transition: 'all 0.2s', boxShadow: 'var(--shadow-soft)' },
    tableCard: { backgroundColor: '#fff', borderRadius: '16px', border: '1px solid var(--color-border)', overflow: 'hidden', boxShadow: 'var(--shadow-soft)' },
    table: { width: '100%', borderCollapse: 'collapse', textAlign: 'left' },
    thRow: { backgroundColor: '#ffffff', borderBottom: '1px solid var(--color-border)' },
    ...
    noResults: { padding: '40px', textAlign: 'center', color: '#666', borderTop: '1px solid var(--color-border)' }
};
