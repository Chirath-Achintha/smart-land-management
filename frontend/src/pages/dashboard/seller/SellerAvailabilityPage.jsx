                ...
                <div className="ui-card" style={S.card}>
                    ...
                    <div style={S.addSection}>
                        ...
                        <div style={S.slotInputRow}>
                            ...
                            <span style={{ color: 'var(--color-muted)', fontWeight: 'bold' }}>to</span>
...
const S = {
    ...
    card: { background: '#fff', borderRadius: '24px', boxShadow: 'none', border: '1px solid rgba(38, 50, 56, 0.1)', padding: '40px', maxWidth: '820px', position: 'relative' },
    tabRow: { display: 'flex', background: 'rgba(38, 50, 56, 0.08)', borderRadius: '12px', padding: '5px', gap: '5px', marginBottom: '32px' },
    tabBtn: { flex: 1, padding: '12px', border: 'none', borderRadius: '10px', fontSize: '0.9rem', fontWeight: '600', cursor: 'pointer', background: 'transparent', color: 'var(--color-muted)', transition: 'all 0.2s' },
    tabActive: { background: '#fff', color: 'var(--color-dark)', fontWeight: '800', boxShadow: 'none' },
    ...
    select: { padding: '12px 16px', border: '1.5px solid rgba(38, 50, 56, 0.16)', borderRadius: '10px', fontSize: '0.95rem', fontFamily: 'inherit', outline: 'none', cursor: 'pointer', background: '#fff', minWidth: '240px', color: 'var(--color-dark)' },
    locationTag: { fontSize: '0.82rem', color: 'var(--color-dark)', background: 'rgba(139, 195, 74, 0.16)', padding: '6px 14px', borderRadius: '20px', fontWeight: '600' },
    divider: { border: 'none', borderTop: '1.5px solid rgba(38, 50, 56, 0.1)', margin: '32px 0' },
    addSection: { marginBottom: '32px' },
    hint: { fontSize: '0.82rem', color: 'var(--color-muted)', marginBottom: '16px', marginTop: '-4px' },
    errMsg: { background: 'rgba(161, 136, 127, 0.16)', color: '#7a4f41', padding: '12px 16px', borderRadius: '10px', fontSize: '0.88rem', marginBottom: '16px', border: '1px solid rgba(161, 136, 127, 0.35)' },
    slotInputRow: { display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' },
    input: { padding: '12px 16px', border: '1.5px solid rgba(38, 50, 56, 0.16)', borderRadius: '10px', fontSize: '0.95rem', fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box', background: '#fff', color: 'var(--color-dark)' },
    addBtn: { padding: '12px 24px', background: 'var(--color-primary)', color: '#fff', border: 'none', borderRadius: '10px', fontWeight: '700', fontSize: '0.9rem', cursor: 'pointer', whiteSpace: 'nowrap' },
    ...
    slotChip: { display: 'flex', alignItems: 'center', gap: '10px', background: 'rgba(139, 195, 74, 0.14)', borderRadius: '10px', padding: '8px 14px', fontSize: '0.88rem', border: '1px solid rgba(139, 195, 74, 0.3)' },
    slotTime: { color: 'var(--color-dark)', fontWeight: '700' },
    removeBtn: { background: 'none', border: 'none', color: 'var(--color-muted)', cursor: 'pointer', fontSize: '1.3rem', lineHeight: 1, padding: 0 },
    noSlots: { color: 'var(--color-muted)', fontSize: '0.88rem', fontStyle: 'italic', marginBottom: '32px' },
    footer: { display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '20px', borderTop: '1.5px solid rgba(38, 50, 56, 0.08)', paddingTop: '32px' },
    saveBtn: { padding: '14px 40px', borderRadius: '12px', fontWeight: '700', fontSize: '1rem', background: '#2e7d32', color: '#fff', border: 'none' },
    successToast: { position: 'absolute', bottom: '40px', left: '40px', background: '#fff', border: '1px solid rgba(76, 175, 80, 0.4)', borderRadius: '14px', padding: '18px 26px', display: 'flex', alignItems: 'center', gap: '18px', boxShadow: '0 12px 40px rgba(76, 175, 80, 0.15)', animation: 'slideUp 0.4s ease-out', zIndex: 100 },
    toastIcon: { background: 'var(--color-primary)', color: '#fff', width: '32px', height: '32px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '900', fontSize: '1rem' },
    toastTitle: { fontWeight: '900', fontSize: '1rem', color: 'var(--color-dark)', marginBottom: '2px' },
    toastDesc: { fontSize: '0.85rem', color: 'var(--color-muted)' },
};
