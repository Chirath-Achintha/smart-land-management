...
const S = {
    ...
    card: { background: '#fff', borderRadius: '20px', padding: '36px', boxShadow: 'var(--shadow-soft)', border: '1px solid var(--color-border)', maxWidth: '820px' },
    ...
    select: { padding: '11px 14px', border: '1px solid var(--color-border)', borderRadius: '8px', fontSize: '0.9rem', fontFamily: "'DM Sans', sans-serif", outline: 'none', cursor: 'pointer', background: '#fff', minWidth: '240px' },
    locationTag: { fontSize: '0.8rem', color: '#999', background: 'var(--color-bg)', padding: '5px 12px', borderRadius: '20px', fontWeight: '600' },
    divider: { border: 'none', borderTop: '1px solid var(--color-border)', margin: '24px 0' },
    ...
    input: { padding: '12px 14px', border: '1px solid var(--color-border)', borderRadius: '8px', fontSize: '0.9rem', fontFamily: "'DM Sans', sans-serif", outline: 'none', width: '100%', boxSizing: 'border-box' },

    // Duration
    durationBox: { background: 'var(--color-bg)', border: '1px solid var(--color-border)', borderRadius: '12px', padding: '20px 24px', marginBottom: '4px' },
    ...
    spinnerWrap: { display: 'flex', alignItems: 'center', border: '1px solid var(--color-border)', borderRadius: '8px', overflow: 'hidden', background: '#fff' },
    spinBtn: { border: 'none', background: 'var(--color-bg)', color: '#555', fontWeight: '700', fontSize: '1.1rem', padding: '8px 14px', cursor: 'pointer', lineHeight: 1, userSelect: 'none' },
    ...
    durationPreview: { marginLeft: 'auto', textAlign: 'right', paddingLeft: '16px', borderLeft: '1px solid var(--color-border)' },
    ...
    presetBtn: { padding: '5px 13px', border: '1px solid var(--color-border)', borderRadius: '20px', fontSize: '0.78rem', fontWeight: '600', cursor: 'pointer', background: '#fff', color: '#555', transition: 'all 0.15s' },
    presetBtnActive: { background: 'var(--color-dark)', color: '#fff', border: '1px solid var(--color-dark)' },
    ...
    quickClosed: { background: 'var(--color-bg)', color: '#aaa', border: '1px solid var(--color-border)' },

    // Footer
    footer: { display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '16px', borderTop: '1px solid var(--color-border)', paddingTop: '24px', flexWrap: 'wrap' },
    errMsg: { fontSize: '0.85rem', color: '#d32f2f', fontWeight: '600' },
    saveBtn: { padding: '12px 32px', borderRadius: '8px', fontWeight: '700', fontSize: '0.95rem', background: 'var(--color-primary)', color: '#fff', border: 'none', cursor: 'pointer', transition: 'all 0.2s' },
