...
const S = {
    ...
    landCard: { display: 'flex', alignItems: 'flex-start', gap: '14px', background: '#fff', padding: '14px', borderRadius: '14px', border: '1px solid #e5e0da', cursor: 'pointer', transition: 'all 0.15s ease-in-out', boxShadow: '0 2px 6px rgba(0,0,0,0.02)' },
    landCardActive: { borderColor: '#1A1A1A', background: '#FAF6F1', boxShadow: '0 4px 12px rgba(0,0,0,0.06)' },
    landCardIcon: { fontSize: '1.8rem', width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f5f0ea', borderRadius: '10px', flexShrink: 0 },
    ...
    dialog: { background: '#fff', borderRadius: '20px', padding: '36px', maxWidth: '440px', width: '90%', textAlign: 'center', boxShadow: '0 20px 60px rgba(0,0,0,0.15)' },
    dialogIcon: { fontSize: '2.5rem', marginBottom: '12px' },
    dialogTitle: { fontSize: '1.25rem', fontWeight: '800', color: '#1A1A1A', marginBottom: '12px', marginTop: 0 },
    dialogBody: { fontSize: '0.9rem', color: '#555', lineHeight: '1.6', marginBottom: '28px' },
    dialogBtns: { display: 'flex', gap: '12px', justifyContent: 'center' },
    dialogKeepBtn: { padding: '12px 24px', background: '#fff', border: '1.5px solid #ddd', borderRadius: '10px', fontWeight: '700', cursor: 'pointer', fontSize: '0.9rem', color: '#555' },
